...
Usage:
    ...
    from sentinel.integrations.llamaindex import wrap_llm

    Settings.llm = wrap_llm(OpenAI(model="gpt-4o"))

    # Option 3: Use SentinelLLM directly
    from sentinel.integrations.llamaindex import SentinelLLM
...
def setup_sentinel_monitoring(
    ...
    Example:
        from sentinel.integrations.llamaindex import setup_sentinel_monitoring
