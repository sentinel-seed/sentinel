...
def prepare_anthropic_request(
    ...
    **kwargs,
    ...
    Example:
        import requests
        from sentinel.integrations.raw_api import prepare_anthropic_request
...
def create_openai_request_body(
    ...
    **kwargs,
    ...
    Example:
        ...
        from sentinel.integrations.raw_api import create_openai_request_body
...
class RawAPIClient:
    ...
    Example:
        from sentinel.integrations.raw_api import RawAPIClient
