...
Usage:
    ...
    from sentinel.integrations.anthropic_sdk import wrap_anthropic_client

    client = Anthropic()
    safe_client = wrap_anthropic_client(client)

    # Option 3: Just inject seed into system prompt
    from sentinel.integrations.anthropic_sdk import inject_seed
...
class SentinelAsyncAnthropic:
    ...
    Example:
        from sentinel.integrations.anthropic_sdk import SentinelAsyncAnthropic
...
def create_safe_client(
    ...
    Example:
        from sentinel.integrations.anthropic_sdk import create_safe_client
