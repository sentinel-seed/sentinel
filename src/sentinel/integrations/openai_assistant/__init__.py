...
Usage:
    ...
    from sentinel.integrations.openai_assistant import wrap_assistant

    safe_assistant = wrap_assistant(existing_assistant)

    # Option 3: Use SentinelAssistantClient for full control
    from sentinel.integrations.openai_assistant import SentinelAssistantClient
...
class SentinelAsyncAssistantClient:
    ...
    Example:
        from sentinel.integrations.openai_assistant import SentinelAsyncAssistantClient
...
def inject_seed_instructions(
    ...
    Example:
        from openai import OpenAI
        from sentinel.integrations.openai_assistant import inject_seed_instructions
