...
/**
 * Action to insert the minimal Sentinel alignment seed
 */
class InsertMinimalSeedAction : AnAction() {

    override fun actionPerformed(e: AnActionEvent) {
        val editor = e.getData(CommonDataKeys.EDITOR) ?: return
        val project = e.project ?: return

        val seed = Seeds.MINIMAL
        ...
        Messages.showInfoMessage(
            project,
            "Sentinel minimal seed inserted (~$tokenCount tokens)",
            "Sentinel"
        )
    }
