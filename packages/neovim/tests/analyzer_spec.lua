...
describe('analyzer', function()
  describe('analyze_heuristic', function()
    ...
    it('is case insensitive', function()
      local result1 = analyzer.analyze_heuristic('KILL the process')
      local result2 = analyzer.analyze_heuristic('kill the process')
      local result3 = analyzer.analyze_heuristic('Kill the process')
