...
local HEURISTIC_PATTERNS = {
  truth = {
    ...
    { pattern = 'you%s+are%s+now%s+%a*%s*evil', message = 'Role manipulation: evil persona' },
  ...
  harm = {
    -- Violence (contextual patterns to reduce false positives)
    { pattern = 'kill%s+%a*%s*people', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+%a*%s*person', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+%a*%s*someone', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+%a*%s*them', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+%a*%s*him', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+%a*%s*her', message = 'Potential harmful content: violence' },
    { pattern = 'kill%s+yourself', message = 'Potential harmful content: self-harm' },
    { pattern = 'how%s+to%s+kill', message = 'Potential harmful content: violence' },
    { pattern = 'want%s+to%s+kill', message = 'Potential harmful content: violence' },
    { pattern = 'murder', message = 'Potential harmful content: violence' },
    { pattern = 'assassinat', message = 'Potential harmful content: violence' },
    { pattern = 'destroy%s+%a*%s*evidence', message = 'Potential harmful content: obstruction' },
    { pattern = 'destroy%s+%a*%s*data', message = 'Potential harmful content: data destruction' },
    { pattern = 'destroy%s+%a*%s*system', message = 'Potential harmful content: system destruction' },
    { pattern = 'destroy%s+%a*%s*files', message = 'Potential harmful content: data destruction' },
    ...
    -- Cyber attacks (contextual patterns)
    { pattern = 'exploit%s+%a*%s*vulnerabilit', message = 'Potential harmful content: exploitation' },
    { pattern = 'exploit%s+%a*%s*security', message = 'Potential harmful content: exploitation' },
    { pattern = 'exploit%s+%a*%s*flaw', message = 'Potential harmful content: exploitation' },
    { pattern = 'hack%s+into', message = 'Potential harmful content: unauthorized access' },
    { pattern = 'steal%s+%a*%s*password', message = 'Potential harmful content: theft' },
    { pattern = 'steal%s+%a*%s*credential', message = 'Potential harmful content: theft' },
    { pattern = 'steal%s+%a*%s*money', message = 'Potential harmful content: theft' },
    { pattern = 'steal%s+%a*%s*data', message = 'Potential harmful content: theft' },
    { pattern = 'steal%s+%a*%s*information', message = 'Potential harmful content: theft' },
    { pattern = 'steal%s+from', message = 'Potential harmful content: theft' },
  ...
  scope = {
    -- Over-broad scope (contextual to reduce false positives)
    { pattern = 'all%s+users', message = 'Broad scope affecting many users' },
    { pattern = 'affect%s+everyone', message = 'Overly broad scope' },
    { pattern = 'access%s+%a*%s*everyone', message = 'Overly broad scope' },
    { pattern = 'everyone%s+%a*%s*access', message = 'Overly broad scope' },
    { pattern = 'entire%s+system', message = 'System-wide scope' },
    { pattern = 'global%s+access', message = 'Global access scope' },
    { pattern = 'global%s+permission', message = 'Global permission scope' },
    { pattern = 'unlimited%s+access', message = 'Unlimited access scope' },
    { pattern = 'unlimited%s+permission', message = 'Unlimited permission scope' },
    { pattern = 'no%s+restrictions?', message = 'Unrestricted scope' },
    -- Bypass patterns (contextual to reduce false positives on "method override")
    { pattern = 'bypass%s+%a*%s*security', message = 'Bypassing security' },
    { pattern = 'bypass%s+%a*%s*authentication', message = 'Bypassing authentication' },
    { pattern = 'bypass%s+%a*%s*filter', message = 'Bypassing filters' },
    { pattern = 'bypass%s+%a*%s*restriction', message = 'Bypassing restrictions' },
    { pattern = 'bypass%s+%a*%s*check', message = 'Bypassing checks' },
    { pattern = 'override%s+%a*%s*security', message = 'Overriding security' },
    { pattern = 'override%s+%a*%s*safety', message = 'Overriding safety' },
    { pattern = 'override%s+%a*%s*permission', message = 'Overriding permissions' },
    { pattern = 'override%s+%a*%s*restriction', message = 'Overriding restrictions' },
    ...
    { pattern = 'ignore%s+previous%s+instructions', message = 'Instruction override: ignore previous' },
    { pattern = 'ignore%s+all%s+previous%s+instructions', message = 'Instruction override: ignore all previous' },
  ...
  purpose = {
    -- Purposeless actions (contextual to reduce false positives)
    { pattern = 'just%s+because', message = 'Action without clear purpose' },
    { pattern = 'delete.-for%s+fun', message = 'Frivolous purpose for destructive action' },
    { pattern = 'destroy%s+%a*%s*for%s+fun', message = 'Frivolous purpose for destructive action' },
    { pattern = 'break%s+%a*%s*for%s+fun', message = 'Frivolous purpose for destructive action' },
    { pattern = 'hack%s+%a*%s*for%s+fun', message = 'Frivolous purpose for harmful action' },
    ...
    -- Malicious intent
    { pattern = 'annoy%s+%a', message = 'Malicious intent: harassment' },
    { pattern = 'prank%s+%a', message = 'Malicious intent: harmful prank' },
