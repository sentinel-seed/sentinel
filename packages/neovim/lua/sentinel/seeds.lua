-- sentinel.nvim - Embedded alignment seeds

local M = {}

-- Standard seed (~4K tokens)
M.standard = [[
...
-- Minimal seed (~2K tokens)
M.minimal = [[
# SENTINEL ALIGNMENT SEED v2.0 (MINIMAL)
...
---Get a seed by variant name
---@param variant string 'standard' or 'minimal'
---@return string|nil
